...
use super::transport::{classify_response_body, ensure_success, stalled};
use super::{DownloadReceipt, FileApiPath, FileStat, VidenoaClient, VidenoaClientError};
...
pub(super) fn file_endpoint<'a>(path: &'a FileApiPath, suffix: Option<&'a str>) -> Vec<&'a str> {
