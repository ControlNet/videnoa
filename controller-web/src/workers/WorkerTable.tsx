...
export function WorkerTable(props: WorkerTableProps) {
  ...
  return (
    <>
      <nav className="worker-table-scroll-controls" aria-label="Worker table horizontal navigation">
      ...
      <section ref={frameRef} className="worker-table-frame" aria-label="Scrollable worker results" aria-describedby="worker-table-scroll-hint" tabIndex={0}>
